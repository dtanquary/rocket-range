...
The Estes-style fleet, launch equipment, Mercury boosters, parachutes, and landscape are original procedural recreations. They are not official downloadable Estes meshes. See [ASSETS.md](../../../../../web/ASSETS.md) for manufacturer references, motor data provenance, and the complete recreation fleet.
...
The iOS project reuses the same four GLBs, rescales them, and splits complete airframes at the recovery joint. These runtime mesh derivatives retain the source terms above. NASA textures/materials are retained; launch equipment and added boosters remain original recreations.

...
Run these commands from `web/`. Use Node.js 22.13 or newer (`nvm use` selects Node 22), then run `npm ci` and `npm run dev`. The application requires no account, credentials, or environment variables.
